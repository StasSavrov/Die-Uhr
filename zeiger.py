...
def stelle_zeiger():
    sek = localtime(time())[5]
    min = localtime(time())[4]
    hour = localtime(time())[3]   
...
sekundenzeiger = myCanvas.create_line(400,400,750, 400, fill = "pink", width=2)
minutenzeiger = myCanvas.create_line(400,400,700, 400, fill = "green", width=4)
stundenzeiger = myCanvas.create_line(400,400,600, 400, fill = "blue", width=8)
